...
void USuspicionIndicator::SetWidgetOffestAndRotation(float OffsetDistanceFar, float OffsetDistanceClose,float RotationToEnemyInScreenSpace,FVector EnemyWorldPosition)
{
